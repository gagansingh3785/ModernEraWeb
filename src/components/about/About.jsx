    ...
    return (
        <section className="about section" id="about">
            ...
            <div className="about_container container grid">
                                ...
                                <div className="skills_group">
                                    <div className="skills_data">
                                        ...
                                        <div>
                                            ...
                                            <span className="skills_levle">Basic</span>
                                        </div>
                                    </div>
                ...
                {/* <div className="about_slider_container" style={{border: "1px solid blue"}}>
                    <div className="about_data" style={{border: "1px solid red"}}>
                        <div>
                            <Info />
